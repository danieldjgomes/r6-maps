...
import level1 from '../../../assets/maps/r6-maps-lair-blueprint-1.jpg'
import level2 from '../../../assets/maps/r6-maps-lair-blueprint-2.jpg'
import level3 from '../../../assets/maps/r6-maps-lair-blueprint-4.jpg'
import {Floor} from "../Enums";

export class Lair extends R6Map {
    constructor() {
